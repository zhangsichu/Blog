...
<channel>
<title><%=Web_Owner%>'s Blog</title>
<link>http://<%=Request.ServerVariables("SERVER_NAME")%>/default.asp</link>
<language>zh-cn</language>
<docs>Lastest 10 article</docs>
<generator>Rss Generator By <%=Web_Owner%>'s.com</generator>
<%
openBlog
Set rs=conn.ExeCute("SELECT TOP 10 * FROM Blog_Content ORDER BY Content_Id DESC")
Do While Not rs.Eof
%>
<item>
...
<description> <![CDATA[<%=UbbCode(HTMLEncode(left(rs("Content_Content"),instr(110,rs("Content_Content"),"¡£"))),(Not rs("Content_Ubb")),"")%>]]></description>
</item>
<%
rs.Movenext
Loop 
