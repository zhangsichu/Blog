        ...
        <tr>
			...
			rs.Movenext
  			...
  			Set rs=Nothing
                                ...
                                <% If Is_ListByYear Then %>
                                <tr>
                                    <td style="text-align:right; height:30px; padding-right:15px; font-weight:bold; vertical-align:top;" class="content">
                                    <a href="yearview.asp" target="_blank">@All</a> 
                                    <% 
                                    For startYear =  Year(Date()) To Web_StartYear STEP -1
                                        Response.Write("  <a href=""yearview.asp?Blog_Year=" & startYear & """ target=""_blank"">" & startYear &"</a>")
                                    Next
                                    %>
                                    </td>
                                </tr>
